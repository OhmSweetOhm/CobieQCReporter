...
public abstract class SpreadsheetTemplateRow {
    ...
    public void populateFromXLSXRow(Row row) throws IllegalAccessException, IllegalArgumentException,
        ...
        for (ColumnAddress columnAddress : ColumnAddress.values()) {
            if (columnProperties.containsKey(columnAddress)) {
                ...
                Property<?> property = (Property) propertyGetter.invoke(this);
            ...
            if (cellValue instanceof Date) {
                ...
                try {
                    ...
                    COBieStringHandlerSettings settings =
                        new COBieStringHandlerSettings(EmptyStringMode.REPLACE_WITH_NA,
                                                       SpecialCharacterMode.REMOVE,
                                                       TrailingDelimiterMode.REMOVE,
                                                       InvalidDateTimeStringMode.SET_TO_NULL);
