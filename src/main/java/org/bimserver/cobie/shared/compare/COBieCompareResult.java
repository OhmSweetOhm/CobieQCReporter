...
public class COBieCompareResult// extends SCompareResult
{
    ...
    public COBieCompareResult(long roid1, long roid2, PluginInterface pluginInterface, Bimsie1ServiceInterface serviceInterface) throws
                                                                                                                                 Exception {
        initializeState();
        this.roid1 = roid1;
        this.roid2 = roid2;
    ...
    public COBieCompareDocument asCOBieCompareDocument() throws Exception {
    ...
    public void initializeBiMServerCompare(long roid1, long roid2, PluginInterface pluginInterface, Bimsie1ServiceInterface serviceInterface) throws
                                                                                                                                              Exception {
        // initializeState();
        this.roid1 = roid1;
        this.roid2 = roid2;
    ...
    private COBieCompareDocument initializeCOBieCompareDocumentWithBiMServerMetadata() throws Exception {
        COBieCompareDocument compareDocument = COBieCompareDocument.Factory.newInstance();
