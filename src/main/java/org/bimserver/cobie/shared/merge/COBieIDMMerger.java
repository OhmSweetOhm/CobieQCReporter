...
import org.bimserver.cobie.shared.compare.COBieCompareResult;
import org.bimserver.cobie.shared.merge.COBieMergeState.MergeMode;
...
public class COBieIDMMerger extends COBieMerger<COBieMergeIDMItem, COBieMergeIDMItem, COBieMergeIDMDocument, COBieMergeIDMDocument, COBIEDocument>
{
    ...
    private COBieCompareDocument getCompareResult() throws Exception {
    ...
    private COBIESheetDictionary getMergedCOBIESheetDictionary() throws Exception {
