...
public class PluginUtilities
{
    ...
    public static final String DEFAULT_COBIESHEETXMLDATA_DESERIALIZER_NAME = COBieDeserializerPluginName.COBie_TAB.toString();
    ...
    public static COBIEDocument getCOBieFromROID(long roid, PluginInterface pluginInterface, Bimsie1ServiceInterface  serviceInterface) throws
                                                                                                                                        Exception {
