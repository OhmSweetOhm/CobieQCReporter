...
public class ImpactTransformer extends SpreadsheetMLTransformer
{
    public ImpactTransformer(COBIEType cobie, Workbook workbook, COBieStringHandler cobieStringWriter)
    {
    ...
    {
        COBIEType.Impacts impacts = getTarget().addNewImpacts();
