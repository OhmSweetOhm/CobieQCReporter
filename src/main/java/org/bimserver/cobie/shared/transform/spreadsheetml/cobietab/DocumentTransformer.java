...
import org.bimserver.cobie.shared.COBieTokenUtility.DocumentColumnNameLiterals;
import org.bimserver.cobie.shared.utility.COBieStringHandler;
import org.bimserver.cobie.shared.utility.COBieUtility;
import org.nibs.cobie.tab.COBIEType;
import org.nibs.cobie.tab.DocumentType;

public class DocumentTransformer extends SpreadsheetMLTransformer
{

    public DocumentTransformer(COBIEType cobie, Workbook workbook, COBieStringHandler cobieStringWriter)
    {
        super(workbook, cobie, cobieStringWriter);
    }

    public DocumentTransformer(COBIEType cobie, Workbook workbook)
    {
    ...
    {
        COBIEType.Documents documents = getTarget().addNewDocuments();
