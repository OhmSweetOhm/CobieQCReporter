...
public class CoordinateTransformer extends SpreadsheetMLTransformer
{
    public CoordinateTransformer(COBIEType cobie, Workbook workbook, COBieStringHandler cobieStringWriter)
    {
    ...
    {
        COBIEType.Coordinates coordinates = getTarget().addNewCoordinates();
