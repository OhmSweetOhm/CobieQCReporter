...
public class JobTransformer extends SpreadsheetMLTransformer
{
    public JobTransformer(COBIEType cobie, Workbook workbook, COBieStringHandler cobieStringWriter)
    {
    ...
    {
        COBIEType.Jobs jobs = getTarget().addNewJobs();
