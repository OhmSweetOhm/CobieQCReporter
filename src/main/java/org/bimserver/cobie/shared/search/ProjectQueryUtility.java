...
public class ProjectQueryUtility
{
    ...
    public static long getRootProjectIdByName(String projectName, Bimsie1ServiceInterface service) throws Exception {
    ...
    public static long getSubprojectIdByParentIdAndSubprojectName(long parentOid, String subprojectName, Bimsie1ServiceInterface service) throws
                                                                                                                                          Exception {
