...
public class BimServerImporter {
	...
	public User createUser(DatabaseSession databaseSession, long remoteUoid) throws Exception {
...
//			}
	...
	private Project createProject(DatabaseSession databaseSession, long poid) throws Exception {
