...
public class ModelHelper {
	...
	private static void initObjectIdmCache(final MetaDataManager metaDataManager) {
		...
		for (PackageMetaData packageMetaData : metaDataManager.getAllIfc()) {
			final HideAllInversesObjectIDM
             hideAllInverse = new HideAllInversesObjectIDM(CollectionUtils.singleSet(packageMetaData.getEPackage()), packageMetaData.getSchemaDefinition());
