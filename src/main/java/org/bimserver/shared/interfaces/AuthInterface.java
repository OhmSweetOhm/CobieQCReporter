...
public interface AuthInterface extends PublicInterface {
	...
	SUser getLoggedInUser() throws Exception;
	...
	Boolean changePassword(@WebParam(name = "uoid", partName = "changePassword.uoid") Long uoid,
                          ...
                          @WebParam(name = "newPassword", partName = "changePassword.newPassword")
	...
	void setHash(@WebParam(name = "uoid", partName = "setHash.uoid") Long uoid,
                @WebParam(name = "hash", partName = "setHash.hash") byte[] hash,
                @WebParam(name = "salt", partName = "setHash.salt") byte[] salt) throws Exception;
	...
	void requestPasswordChange(@WebParam(name = "username", partName = "requestPasswordChange.username") String username,
                              @WebParam(name = "resetUrl", partName = "requestPasswordChange.resetUrl")
                                  String resetUrl) throws Exception;
...
//		@WebParam(name = "validitySeconds", partName = "createToken.validitySeconds") Integer validitySeconds) throws UserException, ServerException;
	...
	SUser validateAccount(@WebParam(name = "uoid", partName = "validateAccount.uoid") Long uoid,
                         ...
                         @WebParam(name = "password", partName = "validateAccount.password") String password) throws
																																				  Exception;
}
