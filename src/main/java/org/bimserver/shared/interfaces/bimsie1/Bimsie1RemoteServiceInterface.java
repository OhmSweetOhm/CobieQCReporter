...
public interface Bimsie1RemoteServiceInterface extends PublicInterface {
	...
	void newRevision(@WebParam(name = "poid", partName = "newRevision.poid") Long poid,
                    @WebParam(name = "roid", partName = "newRevision.roid") Long roid,
                    @WebParam(name = "soid", partName = "newRevision.soid") Long soid,
                    @WebParam(name = "serviceIdentifier", partName = "newRevision.serviceIdentifier")
                        String serviceIdentifier,
                    @WebParam(name = "profileIdentifier", partName = "newRevision.profileIdentifier")
                    ...
                    @WebParam(name = "apiUrl", partName = "newRevision.apiUrl") String apiUrl) throws Exception;
	...
	void newExtendedDataOnProject(@WebParam(name = "poid", partName = "newExtendedDataOnProject.poid") Long poid,
                                 ...
                                 @WebParam(name = "serviceIdentifier",
                                           partName = "newExtendedDataOnProject.serviceIdentifier")
                                     String serviceIdentifier,
                                 @WebParam(name = "profileIdentifier",
                                           partName = "newExtendedDataOnProject.profileIdentifier")
                                     String profileIdentifier,
                                 @WebParam(name = "userToken", partName = "newExtendedDataOnProject.userToken")
                                     String userToken,
                                 @WebParam(name = "token", partName = "newExtendedDataOnProject.token") String token,
                                 @WebParam(name = "apiUrl", partName = "newExtendedDataOnProject.apiUrl") String apiUrl) throws
																																								 Exception;
	...
	void newExtendedDataOnRevision(@WebParam(name = "poid", partName = "newExtendedDataOnRevision.poid") Long poid,
                                  ...
                                  @WebParam(name = "serviceIdentifier",
                                            partName = "newExtendedDataOnRevision.serviceIdentifier")
                                      String serviceIdentifier,
                                  @WebParam(name = "profileIdentifier",
                                            partName = "newExtendedDataOnRevision.profileIdentifier")
                                      String profileIdentifier,
                                  @WebParam(name = "userToken", partName = "newExtendedDataOnRevision.userToken")
                                      String userToken,
                                  @WebParam(name = "token", partName = "newExtendedDataOnRevision.token") String token,
                                  @WebParam(name = "apiUrl", partName = "newExtendedDataOnRevision.apiUrl")
	...
	List<SProfileDescriptor> getPublicProfiles(
       @WebParam(name = "serviceIdentifier", partName = "getPrivateProfiles.serviceIdentifier")
	...
	List<SProfileDescriptor> getPrivateProfiles(
       @WebParam(name = "serviceIdentifier", partName = "getPrivateProfiles.serviceIdentifier")
           String serviceIdentifier, @WebParam(name = "token", partName = "getPrivateProfiles.token") String token) throws
                                                                                                                    Exception;
	...
	SServiceDescriptor getService(
       @WebParam(name = "serviceIdentifier", partName = "getService.serviceIdentifier") String serviceIdentifier) throws
																																						Exception;
}