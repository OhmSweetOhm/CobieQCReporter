...
public interface Bimsie1NotificationInterface extends PublicInterface {
	...
	void newRevision(@WebParam(name = "poid", partName = "progress.poid") Long poid,
                    @WebParam(name = "roid", partName = "progress.roid") Long roid) throws Exception;
	...
	void newProgressOnProjectTopic(@WebParam(name = "poid", partName = "newProgressOnProjectTopic.poid") Long poid,
                                  @WebParam(name = "topicId", partName = "newProgressOnProjectTopic.topicId")
	...
	void closedProgressOnProjectTopic(@WebParam(name = "poid", partName = "closedProgressOnProjectTopic.poid") Long poid,
                                     @WebParam(name = "topicId", partName = "closedProgressOnProjectTopic.topicId")
                                         Long topicId) throws Exception;
	...
	void newProgressOnServerTopic(
       @WebParam(name = "topicId", partName = "newProgressOnServerTopic.topicId") Long topicId) throws Exception;
	...
	void closedProgressOnServerTopic(
       @WebParam(name = "topicId", partName = "closedProgressOnServerTopic.topicId") Long topicId) throws Exception;
	...
	void newProgressOnRevisionTopic(@WebParam(name = "poid", partName = "newProgressOnRevisionTopic.poid") Long poid,
                                   @WebParam(name = "roid", partName = "newProgressOnRevisionTopic.roid") Long roid,
                                   @WebParam(name = "topicId", partName = "newProgressOnRevisionTopic.topicId")
                                       Long topicId) throws Exception;
	...
	void closedProgressOnRevisionTopic(
       ...
       @WebParam(name = "topicId", partName = "closedProgressOnRevisionTopic.topicId") Long topicId) throws Exception;
	...
	void newProgressTopic(@WebParam(name = "topicId", partName = "newProgressTopic.topicId") Long topicId) throws
                                                                                                          Exception;
	...
	void newExtendedData(@WebParam(name = "roid", partName = "newExtendedData.roid") Long roid,
                        @WebParam(name = "edid", partName = "newExtendedData.edid") Long edid) throws Exception;
	...
	void newProject(@WebParam(name = "poid", partName = "newProject.poid") Long poid) throws Exception;
	...
	void newUser(@WebParam(name = "uoid", partName = "newUser.uoid") Long uoid) throws Exception;
	...
	void progress(@WebParam(name = "topicId", partName = "progress.topicId") Long topicId,
                 @WebParam(name = "state", partName = "progress.state") SLongActionState state) throws Exception;
}