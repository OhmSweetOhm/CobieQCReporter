...
public interface Bimsie1NotificationRegistryInterface extends PublicInterface {
	...
	Long registerProgressTopic(@WebParam(name = "type", partName = "registerProgressTopic.type") SProgressTopicType type,
                              @WebParam(name = "description", partName = "registerProgressTopic.description")
                                  String description) throws Exception;

	@WebMethod(action = "updateProgressTopic")
	void updateProgressTopic(@WebParam(name = "topicId", partName = "registerProgressTopic.topicId") Long topicId,
                            @WebParam(name = "state", partName = "registerProgressTopic.state")
                                SLongActionState state) throws Exception;
	
	@WebMethod(action = "unregisterProgressTopic")
	void unregisterProgressTopic(
       @WebParam(name = "topicId", partName = "unregisterProgressTopic.topicId") Long topicId) throws Exception;
	
	@WebMethod(action = "registerProgressHandler")
	void registerProgressHandler(@WebParam(name = "topicId", partName = "registerProgressHandler.topicId") Long topicId,
                                @WebParam(name = "endPointId", partName = "registerProgressHandler.endPointId")
	...
	void registerNewRevisionOnSpecificProjectHandler(
       @WebParam(name = "endPointId", partName = "registerNewRevisionOnSpecificProjectHandler.endPointId")
           Long endPointId,
       @WebParam(name = "poid", partName = "registerNewRevisionOnSpecificProjectHandler.poid") Long poid) throws
																																			 Exception;

	@WebMethod(action = "registerNewRevisionHandler")
	void registerNewRevisionHandler(
       @WebParam(name = "endPointId", partName = "registerNewRevisionHandler.endPointId") Long endPointId) throws
																																			  Exception;
	...
	void registerNewExtendedDataOnRevisionHandler(
       ...
       @WebParam(name = "roid", partName = "registerNewExtendedDataOnRevisionHandler.roid") Long roid) throws Exception;

	@WebMethod(action = "unregisterNewExtendedDataOnRevisionHandler")
	void unregisterNewExtendedDataOnRevisionHandler(
       @WebParam(name = "endPointId", partName = "unregisterNewExtendedDataOnRevisionHandler.endPointId")
           Long endPointId,
       @WebParam(name = "roid", partName = "unregisterNewExtendedDataOnRevisionHandler.roid") Long roid) throws
																																			Exception;

	@WebMethod(action = "registerNewProjectHandler")
	void registerNewProjectHandler(
       @WebParam(name = "endPointId", partName = "registerNewProjectHandler.endPointId") Long endPointId) throws
																																			 Exception;

	@WebMethod(action = "unregisterNewProjectHandler")
	void unregisterNewProjectHandler(
       @WebParam(name = "endPointId", partName = "unregisterNewProjectHandler.endPointId") Long endPointId) throws
																																				Exception;

	@WebMethod(action = "registerNewUserHandler")
	void registerNewUserHandler(
       @WebParam(name = "endPointId", partName = "registerNewUserHandler.endPointId") Long endPointId) throws Exception;
	
	@WebMethod(action = "unregisterNewUserHandler")
	void unregisterNewUserHandler(
       @WebParam(name = "endPointId", partName = "unregisterNewUserHandler.endPointId") Long endPointId) throws
																																			Exception;
	
	@WebMethod(action = "unregisterNewRevisionOnSpecificProjectHandler")
	void unregisterNewRevisionOnSpecificProjectHandler(
       @WebParam(name = "endPointId", partName = "unregisterNewRevisionOnSpecificProjectHandler.endPointId")
           Long endPointId,
       @WebParam(name = "poid", partName = "unregisterNewRevisionOnSpecificProjectHandler.poid") Long poid) throws
																																				Exception;

	@WebMethod(action = "unregisterNewRevisionHandler")
	void unregisterNewRevisionHandler(
       @WebParam(name = "endPointId", partName = "unregisterNewRevisionHandler.endPointId") Long endPointId) throws
																																				 Exception;
	...
	void unregisterProgressHandler(
       ...
       @WebParam(name = "endPointId", partName = "unregisterProgressHandler.endPointId") Long endPointId) throws
																																			 Exception;

	@WebMethod(action = "getProgress")
	SLongActionState getProgress(@WebParam(name = "topicId", partName = "getProgress.topicId") Long topicId) throws
                                                                                                            Exception;
	...
	List<Long> getProgressTopicsOnRevision(
       ...
       @WebParam(name = "roid", partName = "getProgressTopicsOnRevision.roid") Long roid) throws Exception;

	@WebMethod(action = "getProgressTopicsOnProject")
	List<Long> getProgressTopicsOnProject(
       @WebParam(name = "poid", partName = "getProgressTopicsOnProject.poid") Long poid) throws Exception;

	@WebMethod(action = "getProgressTopicsOnServer")
	List<Long> getProgressTopicsOnServer() throws Exception;
	...
	Long registerProgressOnRevisionTopic(
       ...
       @WebParam(name = "description", partName = "registerProgressOnRevisionTopic.description")
           String description) throws Exception;
	...
	Long registerProgressOnProjectTopic(
       ...
       @WebParam(name = "description", partName = "registerProgressOnProjectTopic.description")
           String description) throws Exception;
	...
	void registerChangeProgressOnProject(
       ...
       @WebParam(name = "poid", partName = "registerChangeProgressOnProject.poid") Long poid) throws Exception;
	
	@WebMethod(action = "registerChangeProgressOnServer")
	void registerChangeProgressOnServer(
       @WebParam(name = "endPointId", partName = "registerChangeProgressOnServer.endPointId") Long endPointId) throws
																																					Exception;
	
	@WebMethod(action = "unregisterChangeProgressOnServer")
	void unregisterChangeProgressOnServer(
       @WebParam(name = "endPointId", partName = "unregisterChangeProgressOnServer.endPointId") Long endPointId) throws
																																					  Exception;
	...
	void registerChangeProgressOnRevision(
       ...
       @WebParam(name = "poid", partName = "registerChangeProgressOnRevision.poid") Long poid) throws Exception;
	...
	void unregisterChangeProgressOnProject(
       ...
       @WebParam(name = "poid", partName = "unregisterChangeProgressOnProject.poid") Long poid) throws Exception;
	...
	void unregisterChangeProgressOnRevision(
       ...
       @WebParam(name = "poid", partName = "unregisterChangeProgressOnRevision.poid") Long poid) throws Exception;
}