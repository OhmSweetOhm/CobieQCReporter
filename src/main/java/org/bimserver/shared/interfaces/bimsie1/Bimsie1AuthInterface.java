...
public interface Bimsie1AuthInterface extends PublicInterface {
	...
	String login(@WebParam(name = "username", partName = "login.username") String username,
                @WebParam(name = "password", partName = "login.password") String password) throws Exception;
	...
	String loginOpenId(@WebParam(name = "op", partName = "loginOpenId.op") String op,
                      @WebParam(name = "returnUrl", partName = "loginOpenId.returnUrl") String returnUrl) throws
																																			 Exception;
	...
	String validateOpenId(@WebParam(name = "queryString", partName = "validateOpenId.queryString") String queryString) throws
																																							 Exception;
	...
	SAccessMethod getAccessMethod() throws Exception;
	...
	String loginUserToken(@WebParam(name = "token", partName = "loginUserToken.token") String token) throws Exception;
}