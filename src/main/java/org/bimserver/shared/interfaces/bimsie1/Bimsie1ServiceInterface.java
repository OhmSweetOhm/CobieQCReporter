...
public interface Bimsie1ServiceInterface extends PublicInterface {
	...
	void terminateLongRunningAction(
       @WebParam(name = "actionId", partName = "getDownloadData.actionId") Long actionId) throws Exception;
	...
	Long checkout(@WebParam(name = "roid", partName = "checkout.roid") Long roid,
                 @WebParam(name = "serializerOid", partName = "checkout.serializerOid") Long serializerOid,
                 @WebParam(name = "sync", partName = "checkout.sync") Boolean sync) throws Exception;
	...
	Long download(@WebParam(name = "roid", partName = "download.roid") Long roid,
                 ...
                 @WebParam(name = "sync", partName = "download.sync") Boolean sync) throws Exception;
	...
	Long downloadByOids(@WebParam(name = "roids", partName = "downloadCompareResults.roids") Set<Long> roids,
                       @WebParam(name = "oids", partName = "downloadCompareResults.oids") Set<Long> oids,
                       @WebParam(name = "serializerOid", partName = "downloadCompareResults.serializerOid")
                           Long serializerOid,
                       @WebParam(name = "sync", partName = "downloadCompareResults.sync") Boolean sync,
                       @WebParam(name = "deep", partName = "downloadCompareResults.deep") Boolean deep) throws
																																		  Exception;
	...
	Long downloadByTypes(@WebParam(name = "roids", partName = "downloadByTypes.roids") Set<Long> roids,
                        ...
                        @WebParam(name = "serializerOid", partName = "downloadByTypes.serializerOid")
                            Long serializerOid,
                        @WebParam(name = "includeAllSubtypes", partName = "downloadByTypes.includeAllSubtypes")
                            Boolean includeAllSubtypes,
                        @WebParam(name = "useObjectIDM", partName = "downloadByTypes.useObjectIDM")
                            Boolean useObjectIDM,
                        @WebParam(name = "deep", partName = "downloadByTypes.deep") Boolean deep,
                        @WebParam(name = "sync", partName = "downloadByTypes.sync") Boolean sync) throws Exception;
	...
	Long downloadByJsonQuery(@WebParam(name = "roids", partName = "downloadByTypes.roids") Set<Long> roids,
	...
	Long downloadByGuids(@WebParam(name = "roids", partName = "downloadByGuids.roids") Set<Long> roids,
                        @WebParam(name = "guids", partName = "downloadByGuids.guids") Set<String> guids,
                        @WebParam(name = "serializerOid", partName = "downloadByGuids.serializerOid")
                            Long serializerOid,
                        @WebParam(name = "deep", partName = "downloadByGuids.deep") Boolean deep,
                        @WebParam(name = "sync", partName = "downloadByGuids.sync") Boolean sync) throws Exception;
	...
	Long downloadByNames(@WebParam(name = "roids", partName = "downloadByNames.roids") Set<Long> roids,
                        @WebParam(name = "names", partName = "downloadByNames.names") Set<String> names,
                        @WebParam(name = "serializerOid", partName = "downloadByNames.serializerOid")
                            Long serializerOid,
                        @WebParam(name = "deep", partName = "downloadByNames.deep") Boolean deep,
                        @WebParam(name = "sync", partName = "downloadByNames.sync") Boolean sync) throws Exception;
	...
	Long downloadRevisions(@WebParam(name = "roids", partName = "downloadRevisions.roids") Set<Long> roids,
                          @WebParam(name = "serializerOid", partName = "downloadRevisions.serializerOid")
                              Long serializerOid,
                          @WebParam(name = "sync", partName = "downloadRevisions.sync") Boolean sync) throws Exception;
	...
	Long downloadQuery(@WebParam(name = "roid", partName = "downloadQuery.roid") Long roid,
                      ...
                      @WebParam(name = "serializerOid", partName = "downloadQuery.serializerOid")
                          Long serializerOid) throws Exception;
	...
	SSerializerPluginConfiguration getSerializerByName(
       @WebParam(name = "serializerName", partName = "getSerializerByName.serializerName") String serializerName) throws
																																						Exception;
	...
	SDeserializerPluginConfiguration getDeserializerById(
       @WebParam(name = "oid", partName = "getDeserializerById.oid") Long oid) throws Exception;
	...
	SDeserializerPluginConfiguration getDeserializerByName(
       @WebParam(name = "deserializerName", partName = "getDeserializerByName.deserializerName")
           String deserializerName) throws Exception;
	...
	SSerializerPluginConfiguration getSerializerById(
       @WebParam(name = "oid", partName = "getSerializerById.oid") Long oid) throws Exception;
	...
	SSerializerPluginConfiguration getSerializerByContentType(
       @WebParam(name = "contentType", partName = "getSerializerByContentType.contentType") String contentType) throws
																																					 Exception;
	...
	SQueryEnginePluginConfiguration getQueryEngineByName(
       @WebParam(name = "name", partName = "getQueryEngineByName.name") String name) throws Exception;
	...
	SQueryEnginePluginConfiguration getQueryEngineById(
       @WebParam(name = "oid", partName = "getQueryEngineById.oid") Long oid) throws Exception;
	...
	SDeserializerPluginConfiguration getSuggestedDeserializerForExtension(
       ...
       @WebParam(name = "poid", partName = "getSuggestedDeserializerForExtension.poid") Long poid) throws Exception;
	...
	void addExtendedDataToRevision(@WebParam(name = "roid", partName = "addExtendedDataToRevision.roid") Long roid,
                                  @WebParam(name = "extendedData", partName = "addExtendedDataToRevision.extendedData")
	...
	SExtendedData getExtendedData(@WebParam(name = "oid", partName = "getExtendedData.oid") Long oid) throws Exception;
	...
	List<SExtendedData> getAllExtendedDataOfRevision(
       @WebParam(name = "roid", partName = "getAllExtendedDataOfRevision.roid") Long roid) throws Exception;
	...
	SProject getProjectByPoid(@WebParam(name = "poid", partName = "getProjectByPoid.poid") Long poid) throws Exception;
	...
	SProjectSmall getProjectSmallByPoid(
       @WebParam(name = "poid", partName = "getProjectSmallByPoid.poid") Long poid) throws Exception;
	...
	SRevision getRevision(@WebParam(name = "roid", partName = "getRevision.roid") Long roid) throws Exception;
	...
	Boolean undeleteProject(@WebParam(name = "poid", partName = "undeleteProject.poid") Long poid) throws Exception;
	...
	Long branchToNewProject(@WebParam(name = "roid", partName = "branchToNewProject.roid") Long roid,
                           @WebParam(name = "projectName", partName = "branchToNewProject.projectName")
                               String projectName,
                           @WebParam(name = "comment", partName = "branchToNewProject.comment") String comment,
                           @WebParam(name = "sync", partName = "branchToNewProject.sync") Boolean sync) throws
																																		  Exception;
	...
	Long branchToExistingProject(@WebParam(name = "roid", partName = "branchToExistingProject.roid") Long roid,
                                @WebParam(name = "destPoid", partName = "branchToExistingProject.destPoid")
                                    Long destPoid,
                                @WebParam(name = "comment", partName = "branchToExistingProject.comment")
                                    String comment,
                                @WebParam(name = "sync", partName = "branchToNewProject.sync") Boolean sync) throws
																																				 Exception;
	...
	List<SProject> getProjectsByName(@WebParam(name = "name", partName = "getProjectsByName.name") String name) throws
																																					Exception;
	...
	List<SProject> getSubProjects(@WebParam(name = "poid", partName = "getSubProjects.poid") Long poid) throws Exception;
	...
	SExtendedDataSchema getExtendedDataSchemaById(
       @WebParam(name = "oid", partName = "getExtendedDataSchemaById.oid") Long oid) throws Exception;
	...
	List<SRevision> getAllRevisionsOfProject(
       @WebParam(name = "poid", partName = "getAllRevisionsOfProject.poid") Long poid) throws Exception;
	...
	List<SProject> getAllProjects(
       ...
       @WebParam(name = "onlyActive", partName = "getAllProjects.onlyActive") Boolean onlyActive) throws Exception;
	...
	SProject addProject(@WebParam(name = "projectName", partName = "addProject.projectName") String projectName,
                       @WebParam(name = "schema", partName = "addProject.schema") String schema) throws Exception;
	...
	SProject addProjectAsSubProject(
       ...
       @WebParam(name = "schema", partName = "addProjectAsSubProject.schema") String schema) throws Exception;
	...
	Boolean deleteProject(@WebParam(name = "poid", partName = "deleteProject.poid") Long poid) throws Exception;

	@WebMethod(action = "getExtendedDataSchemaByNamespace")
	SExtendedDataSchema getExtendedDataSchemaByNamespace(
       @WebParam(name = "namespace", partName = "getExtendedDataSchemaByNamespace.namespace") String namespace) throws
																																					 Exception;

	@WebMethod(action = "getAllProjectsSmall")
	List<SProjectSmall> getAllProjectsSmall() throws Exception;
}