...
public interface MetaInterface extends PublicInterface {
	...
	List<SServiceInterface> getServiceInterfaces() throws Exception;
	...
	SServiceInterface getServiceInterface(
       @WebParam(name = "getServiceInterface", partName = "getServiceInterface.serviceInterfaceName")
           String serviceInterfaceName) throws Exception;
	...
	List<SServiceMethod> getServiceMethods(
       @WebParam(name = "serviceInterfaceName", partName = "getServiceMethods.serviceInterfaceName")
           String serviceInterfaceName) throws Exception;
	...
	SServiceMethod getServiceMethod(
       @WebParam(name = "serviceInterfaceName", partName = "getServiceMethod.serviceInterfaceName")
           String serviceInterfaceName,
       @WebParam(name = "methodName", partName = "getServiceMethod.methodName") String methodName) throws Exception;
	...
	List<SServiceType> getServiceTypes() throws Exception;
	...
	List<SServiceParameter> getServiceMethodParameters(
       @WebParam(name = "serviceInterfaceName", partName = "getServiceMethodParameters.serviceInterfaceName")
           String serviceInterfaceName,
       @WebParam(name = "serviceMethodName", partName = "getServiceMethodParameters.serviceMethodName")
           String serviceMethodName) throws Exception;

	@WebMethod(action="getEnumLiterals")
	List<String> getEnumLiterals(@WebParam(name = "enumName", partName = "getEnumLiterals.enumName") String enumName) throws
																																							Exception;
