...
public interface AdminInterface extends PublicInterface {
	...
	List<SPluginDescriptor> getAllPlugins() throws Exception;
	...
	void enablePlugin(@WebParam(name = "name", partName = "enablePlugin.name") String name) throws Exception;
	...
	void disablePlugin(@WebParam(name = "name", partName = "disablePlugin.name") String name) throws Exception;
	...
	SDatabaseInformation getDatabaseInformation() throws Exception;
	...
	Date getLastDatabaseReset() throws Exception;
	...
	void setup(@WebParam(name = "siteAddress", partName = "setup.siteAddress") String siteAddress,
              ...
              @WebParam(name = "adminPassword", partName = "setup.adminPassword") String adminPassword) throws
																																		  Exception;
	...
	List<SLogAction> getLogs() throws Exception;
	...
	List<SMigration> getMigrations() throws Exception;
	...
	SServerInfo getServerInfo() throws Exception;
	...
	String getServerLog() throws Exception;
	...
	Integer clearOutputFileCache() throws Exception;
	...
	SSystemInfo getSystemInfo() throws Exception;
	...
	SJavaInfo getJavaInfo() throws Exception;
	...
	SBimServerInfo getBimServerInfo() throws Exception;
	...
	String getProtocolBuffersFile(
       @WebParam(name = "interfaceName", partName = "getProtocolBuffersFile.interfaceName") String interfaceName) throws
																																						Exception;
	...
	SVersion getVersion() throws Exception;
	...
	SVersion getLatestVersion() throws Exception;
	...
	Boolean upgradePossible() throws Exception;
	...
	Date getServerStartTime() throws Exception;
	...
	void regenerateGeometry(@WebParam(name = "croid", partName = "regenerateGeometry.croid") Long croid) throws
																																		  Exception;
	
	@WebMethod(action = "getMetrics")
	SMetrics getMetrics() throws Exception;
}