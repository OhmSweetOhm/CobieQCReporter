...
public class ClientIfcModel extends IfcModel {
	...
	public ClientIfcModel(BimServerClient bimServerClient, long poid, long roid, boolean deep, PackageMetaData packageMetaData, boolean recordChanges, boolean includeGeometry) throws
																																																										 Exception {
	...
	public long commit(String comment) throws Exception {
		return bimServerClient.getBimsie1LowLevelInterface().commitTransaction(tid, comment);
	}

	public long getJsonSerializerOid() throws Exception {
	...
	public long getJsonSerializerWithGeometryOid() throws Exception {
	...
	public long getJsonGeometrySerializerOid() throws Exception {
	...
	public long getBinaryGeometrySerializerOid() throws Exception {
	...
	private void loadDeep() throws Exception {
	...
	private void processDownload(Long download) throws Exception {
	...
	public void checkin(long poid, String comment) throws Exception {
