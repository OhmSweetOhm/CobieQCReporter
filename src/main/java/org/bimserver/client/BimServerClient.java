...
public class BimServerClient implements ConnectDisconnectListener, TokenHolder, ServiceHolder, BimServerClientInterface {
	...
	public void setAuthentication(AuthenticationInfo authenticationInfo) throws Exception {
	...
	public void notifyOfConnect() throws Exception {
	...
	public ClientIfcModel getModel(SProject project, long roid, boolean deep, boolean recordChanges) throws Exception {
		if (roid == -1) {
	...
	public ClientIfcModel getModel(SProject project, long roid, boolean deep, boolean recordChanges, boolean includeGeometry) throws
																																									  Exception {
		if (roid == -1) {
			throw new UserException("Roid cannot be -1");
		}
	...
	public long checkin(long poid, String comment, long deserializerOid, boolean merge, boolean sync, Path file) throws
																																					 Exception {
	...
	public long checkin(long poid, String comment, long deserializerOid, boolean merge, boolean sync, long fileSize, String filename, InputStream inputStream) throws
																																																				  Exception {
		return channel.checkin(baseAddress, token, poid, comment, deserializerOid, merge, sync, fileSize, filename, inputStream);
	}

	public void download(long roid, long serializerOid, OutputStream outputStream) throws Exception {
		try {
	...
	public IfcModelInterface newModel(SProject project, boolean recordChanges) throws Exception {
	...
	@Override
	public Geometry getGeometry(long roid, IfcProduct ifcProduct) throws Exception {
		try {
