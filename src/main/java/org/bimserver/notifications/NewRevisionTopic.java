...
public class NewRevisionTopic extends Topic {
	...
	public void process(final DatabaseSession session, final long poid, final long roid, NewRevisionNotification newRevisionNotification) throws
																																													  Exception {
		map(new Mapper(){
			@Override
			public void map(final EndPoint endPoint) throws Exception {
